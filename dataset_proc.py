...
class PassageIdsDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 old2new_mapper_path="data_concerned/datasets/nq/old2new_id_mapper_train_st5-base_k10_c30.pkl") -> None:
        super().__init__()
...
class PassageGeneratedQueryDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 mode=None,
                 train_ratio=0.9,
                 id_mapper_path="data_concerned/datasets/nq/ID_MAPPER_trn_st5-base_k10_c30.pkl") -> None:
        super().__init__()
